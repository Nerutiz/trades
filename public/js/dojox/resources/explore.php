...
<table id="testMatrix">
	<thead>
		<tr class="top">
			...
			<th colspan="4">Nihilo</th>
			<th colspan="4">Soria</th>
		</tr>
		<tr class="tests">
			<th>Normal</th>
			<th>a11y</th>
...
<p>* note: All themes and modes included for completeness. Some projects
don't even use themes. The "basic" link is the direct link to the file
with no enhancements. The test file must include _testCommon from dijit
to include theme / rtl / a11y testing capabilities.</p>
</body>
</html>
	<?php
